    ...
    <>
      <section id="practice" className="practice-section content-section" aria-labelledby="practice-title">
        <div className="section-topline">
          ...
          <Link to="/skills" className="text-link">Explore all skills <ArrowUpRight size={18} /></Link>
        </div>
      ...
      <section id="contact" className="home-contact content-section" aria-labelledby="contact-title">
        <div className="section-topline">
          ...
          <span className="small-meta">PROJECTS, ROLES, OR A QUESTION</span>
        </div>
        <div className="contact-closing">
          <h2 id="contact-title"><span className="contact-quote-first">What are you trying</span>{' '}<span className="contact-quote-second">to make easier?</span></h2>
